function [x,ERel,k] = Gauss_Jacobi(A,b,tol,kmax)
%GAUSS JACOBI RESOLVE UM SISTEMA QUADRADO SPD PELO MÉTODO ITERATIVO DE
%GAUSS-JACOBI, COM INICIALIZADOR X1 FORMADO POR ELEMENTOS UNITARIOS.
